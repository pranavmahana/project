...
class PSDPlotterApp:
    ...
    def plot_psd(self):
        ...
        f, Pxx = self.calculate_psd(data, fs, n, sensitivity, nperseg=nperseg, noverlap=noverlap, nfft=nfft)
    ...
    def calculate_psd(self, data, fs, n, sensitivity=None, nperseg=None, noverlap=None, nfft=None):
        f, Pxx = welch(data, fs, nperseg=nperseg, noverlap=noverlap, nfft=nfft)
