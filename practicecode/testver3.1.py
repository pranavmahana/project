...
class PSDPlotterApp:
    ...
    def create_widgets(self):
        ...
        # Matplotlib Figure
        self.fig, self.ax = plt.subplots(figsize=(8, 6))  # Increase figure size
    ...
    def export_plot(self):
        if self.fig:
            ...
            if file_path:
                self.fig.savefig(file_path, format='jpeg', dpi=300, bbox_inches='tight')  # Adjusted to include tight bounding box
