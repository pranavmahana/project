...
class PSDPlotterApp:
    def __init__(self, root):
        ...
        self.plot_button = ttk.Button(root, text="Plot G-levels and PSD", command=self.plot_glevels_and_psd)
        self.plot_button.grid(row=7, column=0, pady=10, padx=10, sticky="w")
        ...
        self.canvas_widget.get_tk_widget().grid(row=8, column=0, columnspan=3, pady=5, padx=10, sticky="nsew")
